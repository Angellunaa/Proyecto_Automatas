...
namespace Proyecto_Automatas
{
    public class Automata:Form1
    {
        ...
        public Automata(List<AristaG> v, string i)
        {
            ...
            data.Columns.Add("Funcion de Trancisión");
            data.Columns.Add("Resultado");
        }
        ...
        public void Evaluar_Cadena(NodoG nodo, string cadena)
        {
            bool c = false;
            //data.Rows.Add(nodo.Nombre, cadena, "f(" + cadena + ")", "k");
            ...
            if (nodo != null)
            {
                ...
                if (conexiones.Count > 0)
                {
                        ...
                        foreach (string v in str.Valores)
                        {
                            if (v != "λ")
                            {
                                ...
                                if (valor == v)
                                {
                                    ...
                                    nodo.Dibujar();
                                    data.Rows.Add(str.NodoInicio.Nombre, "'" + cadena + "'", "δ(" + v + ")", str.n2.Nombre);
                                    Evaluar_Cadena(str.n2, nueva);
                                }
                            }
                    ...
                    if (!c)
                    {
                        ...
                        nodo.ColorFondo = Color.Gold;
                        nodo.Dibujar();
                        if (cadena.Equals(string.Empty)) data.Rows.Add(nodo.Nombre, "'" + cadena + "'", "δ(λ)",nodo.Nombre);
                        else data.Rows.Add(nodo.Nombre, "'" + cadena + "'", "δ(" + cadena + ")", "vacío");
                    }
                }
                else
                {
                    if(nodo.Final && string.IsNullOrEmpty(cadena))
                    {
                    ...
                    else
                    {
                        ...
                        nodo.ColorFondo = Color.Gold;
                        nodo.Dibujar();
                        data.Rows.Add(nodo.Nombre, "'" + cadena + "'", "δ(" + cadena + ")", nodo.Nombre);
                    }
                }
            }
            else
